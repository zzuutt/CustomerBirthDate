...
abstract class CustomerBirthDate implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\CustomerBirthDate\\Model\\Map\\CustomerBirthDateTableMap';
    ...
    /**
     * Initializes internal state of CustomerBirthDate\Model\Base\CustomerBirthDate object.
     */
    ...
    /**
     * Compares this with another <code>CustomerBirthDate</code> instance.  If
     * <code>obj</code> is an instance of <code>CustomerBirthDate</code>, delegates to
     * <code>equals(CustomerBirthDate)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return CustomerBirthDate The current object, for fluid interface
     */
    ...
    public function setBirthDate($v)
    {
        ...
        if ($this->birth_date !== null || $dt !== null) {
            if ($dt !== $this->birth_date) {
                $this->birth_date = $dt;
                $this->modifiedColumns[CustomerBirthDateTableMap::BIRTH_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            return $startcol + 2; // 2 = CustomerBirthDateTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating \CustomerBirthDate\Model\CustomerBirthDate object", 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCustomerBirthDateQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CustomerBirthDate::setDeleted()
     * @see CustomerBirthDate::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildCustomerBirthDateQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CustomerBirthDateTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO customer_birth_date (%s) VALUES (%s)',
    ...
    {
        $pos = CustomerBirthDateTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CustomerBirthDate'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CustomerBirthDate\Model\CustomerBirthDate (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \CustomerBirthDate\Model\CustomerBirthDate Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CustomerBirthDateTableMap::DEFAULT_STRING_FORMAT);
    }
